...
/**
 * Retrieve and store token after prompting for user autho
 * @param {google.auth.OAuth2} oAuth2Client The OAuth2 client.
 * @param {getEventsCallback} callback The callback of authorized client.
 */
...
/**
 * Make an OAuth2 client with the credentials.
 * @param {Object} credentials - Authorization client credentials.
 * @param {function} callback - Callback to call the auth client.
 */
...
/**
 * Send mail through the user account.
 * @param {google.auth.OAuth2} auth - The authorized OAuth2 client.
 * @param {gmailV1.Schema$Message} mail - The message.
 */
...
/**
 * Routines for mail delivery with GMail.
 */
