...
/**
 * Generates an images's thumbnail
 * @param {String} filePath - Original image file path.
 * @param {number} size The width of the generated thumbnail.
...
userQueue.process(async (job, done) => {
  ...
  try {
    ...
    const mailContent = [
      ...
      'Welcome to <a href="https://github.com/tshegofatsoseane/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/tshegofatsoseane">Tshegofatso Seane</a>. ',
      'Enjoy.',
      '</div>',
    ].join('');
